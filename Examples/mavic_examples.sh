#!/bin/bash
pathDataset='/home/victor/Documents/MASTER_CERCETARE/data/' #Example, it is necesary to change it by the dataset path

#------------------------------------
# Monocular Examples
echo "Launching Slanic with Monocular sensor"
./Monocular/mono_mavic ../Vocabulary/ORBvoc.txt ./Monocular/Mavic.yaml "$pathDataset"/slanic/DJI_0957-002.mp4 ./slanic
